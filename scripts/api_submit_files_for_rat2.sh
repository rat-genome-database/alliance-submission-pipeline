...
ALLELE_LOC="data/$BATCH/${MOD_NAME}_${AGR_SCHEMA}_allele.${TAXON}.json"
gzip $ALLELE_LOC
ALLELE_FILE="${ALLELE_SPEC}=@${ALLELE_LOC}.gz"
echo "$ALLELE_FILE"

VARIANT_SPEC="${AGR_RELEASE}_VARIATION_${SPECIES}"
VARIANT_LOC="data/$BATCH/${MOD_NAME}_${AGR_SCHEMA}_variant.${TAXON}.json"
gzip $VARIANT_LOC
VARIANT_FILE="${VARIANT_SPEC}=@${VARIANT_LOC}.gz"
echo "$VARIANT_FILE"

EXPR_SPEC="${AGR_RELEASE}_EXPRESSION_${SPECIES}"
EXPR_LOC="data/$BATCH/${MOD_NAME}_${AGR_SCHEMA}_expression.${TAXON}.json"
gzip $EXPR_LOC
...
GENE_LOC="data/$BATCH/${MOD_NAME}_${AGR_SCHEMA}_gene.${TAXON}.json"
GENE_FILE="${GENE_SPEC}=@${GENE_LOC}"
echo "$GENE_FILE"

AGM_SPEC="${AGR_RELEASE}_AGM_${SPECIES}"
AGM_LOC="data/$BATCH/${MOD_NAME}_${AGR_SCHEMA}_affectedGenomicModel.${TAXON}.json"
...
REFERENCE_LOC="data/$BATCH/${MOD_NAME}_${AGR_SCHEMA}_REFERENCE.${TAXON}.json"
gzip $REFERENCE_LOC
REFERENCE_FILE="${REFERENCE_SPEC}=@${REFERENCE_LOC}.gz"
echo "$REFERENCE_FILE"

REFEXCHANGE_SPEC="${AGR_RELEASE}_REF-EXCHANGE_${SPECIES}"
REFEXCHANGE_LOC="data/$BATCH/${MOD_NAME}_${AGR_SCHEMA}_REF-EXCHANGE.${TAXON}.json"
